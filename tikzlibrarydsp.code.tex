...
\tikzset{dspfilter/.style={shape=rectangle,draw,align=center,text depth=0.3em,text height=1em,inner sep=0pt,
	...
	\tikzset{
	dspgainr/.style = {draw, isosceles triangle, line width = 0.75 pt, inner sep = 0pt, text width = 7.5mm, align = center},
	dspgainl/.style = {draw, isosceles triangle, shape border rotate = 180, line width = 0.75 pt, inner sep = 0pt, text width = 7.5mm, align = center}
}
