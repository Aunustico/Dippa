...
Previously, we discussed about the history of animal husbandry milk producing. Additionally, we introduced different types of cowshed. Consequently, in this section we discuss of the cow itself. First, we will cover the dairy cow in general. The following subsection will concentrate on milk yield related estrus and lactation cycles. Inherently, cows are plain animals and they live in hierarchy \cite{julkaisuja52}. In large herds they form smaller groups where they do their daily activities such as eata and rest together \cite{julkaisuja52, lehmahavaintoja}. 

Allowing the cows to follow their natural behavior enables to observe exceptions 


Consequently,  Thus, as social animals it is important for the cows to be able to obey their \cite{julkaisuja52}

 Hence, it is easier to observe their behavior and motion. The target of the observations is to detect any abnormalities related to phases of estrus or health issues. These abnormalities are directly related to milk yield and profitability. Thus, they are in scope of this study. We will discuss specially of the estrus later in this section. First, it is necessary to establish decent general view on dairy cow as follows.



On pasture, cows can move 4 kilometers every day \cite{julkaisuja52}. However, in cowshed their movement reduced down to 400 to 800 meters per day \cite{luomuopas}. 

 
Cows are plain animals and herd animals. Herds have an heararchy. They sleep, eat etc. in same time with others. When pasturing, the cows move 4 km per day. Cow can lick all of its body excluding neck and head. Cows doze standing and sleep lying. The estrus period is approximately 21 days and the estrus lasts from 12 to 16 hours. A bull may detect estrus 2 days before the main estrus.   \cite{julkaisuja52}
