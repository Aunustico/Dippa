...
Previously, we discussed of the dairy farming and the history of animal husbandry in general. In order to proceed the actual topic of this study, it is necessary to discuss of lactation cycle as a root cause for the need of proper estrus detection.  \\ 
...
Estrus is a cyclic event 

The estrus period is considered to begin from ovulation. The duration of an estrus period is approximately 21$\pm$3 days. Typically, the actual estrus lasts from 12 to 16 hours. A bull may detect estrus 2 days before the main estrus.   \cite{julkaisuja52} \\
