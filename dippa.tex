...
Previously, we surveyed through the history of animal husbandry and discussed of the beginning milk producing. Additionally, we introduced such cowsheds as tie-stall and loose-housed cowsheds. Correspondingly, this subsection will debate on the dairy cow itself in general level. Whereas, the subsequent subsections will focus on such milk yield related cycles as estrus and lactation cycles. Inherently, cows are plain and herd animals. Moreover, they live in hierarchy \cite{julkaisuja52}. In large herds they form smaller groups where they do their daily activities such as eat and rest together \cite{julkaisuja52, lehmahavaintoja}. Cows spend most of their day eating and ruminating feed and hey. Simultaneously, they lay down approximately from \SI{11}{\hour} to \SI{12}{\hour} a day. Meanwhile, they stand up and change their pose and position several times \cite{luomunaudanruokinta}.  \\


On pasture, cow can walk several kilometers every day \cite{luomuopas, julkaisuja52} . However, in loose-housed cowshed their range is reduced down from \SI{400}{\metre} to \SI{800}{\metre} per day \cite{luomuopas}. Typically, they walk between different haunts and watering places as well as milking station from 2 to 3 times a day. However, cows are curious but very cautious animals. They can easily be injured, hence they avoid slippery and uneven surfaces as well as pits and stairs. Therefore, the presence of such insecure surfaces can reduce cows daily walk even more \cite{lehmahavaintoja}. Walking enforces the health, increases hormonal activity and metabolism.  \cite{luomuopas}  \\
 ...
 Access to fresh and clean water is vital. Walking enforces the health, increases hormonal activity and metabolism.  \cite{luomuopas} 
