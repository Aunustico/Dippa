...
Previously, we discussed of the hardware components of the dairy cow sensor device. Whereas, the hardware already existing prototype, the software was developed from scratch. 
